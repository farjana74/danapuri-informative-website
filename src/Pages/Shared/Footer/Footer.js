        ...
        <div className='container-fluid footer-segment'>
            ...
            <div className="container mx-auto p-0 py-4">
                <div className="row">
                    ...
                    <div className="col-12 col-sm-12 col-md-3 col-lg-4 text-start pt-3 ps-sm-5">
                        <img src={logo} alt="" className='img-fluid pb-3 m-0' />
                        <p className='footer-title-txt'>Subscribe to our Newsletter</p>

                        <div className=''>
                            <input className='subcribe-input ' type="text" placeholder='Enter your Email' />
                ...
                <div className="row align-items-center pt-3">
                    ...
                    <div className="col-12 col-sm-12 col-md-4 col-lg-4  d-flex justify-content-center align-items-center">
                        <p className='copyright-text'>© Copyright /Techsistbd 2022</p>
